...
import (
	...
	repo "github.com/Rivaldz/my-template-go/internal/repo"
...
// Delete mocks base method.
func (m *MockPostRepo) Delete(ctx context.Context, postID, userID string) error {
	m.ctrl.T.Helper()
...
// Delete indicates an expected call of Delete.
func (mr *MockPostRepoMockRecorder) Delete(ctx, postID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockPostRepo)(nil).Delete), ctx, postID, userID)
}

// GetByID mocks base method.
func (m *MockPostRepo) GetByID(ctx context.Context, postID string) (entity.Post, error) {
	m.ctrl.T.Helper()
...
// GetByID indicates an expected call of GetByID.
func (mr *MockPostRepoMockRecorder) GetByID(ctx, postID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByID", reflect.TypeOf((*MockPostRepo)(nil).GetByID), ctx, postID)
}

// List mocks base method.
func (m *MockPostRepo) List(ctx context.Context, filter repo.PostFilter) ([]entity.Post, int, error) {
	m.ctrl.T.Helper()
...
// Store mocks base method.
func (m *MockPostRepo) Store(ctx context.Context, post *entity.Post) error {
	m.ctrl.T.Helper()
...
// Store indicates an expected call of Store.
func (mr *MockPostRepoMockRecorder) Store(ctx, post any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockPostRepo)(nil).Store), ctx, post)
}
...
// Delete mocks base method.
func (m *MockCommentRepo) Delete(ctx context.Context, commentID, userID string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, commentID, userID)
	ret0, _ := ret[0].(error)
	return ret0
}

// Delete indicates an expected call of Delete.
func (mr *MockCommentRepoMockRecorder) Delete(ctx, commentID, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockCommentRepo)(nil).Delete), ctx, commentID, userID)
}

// GetByID mocks base method.
func (m *MockCommentRepo) GetByID(ctx context.Context, commentID string) (entity.Comment, error) {
	m.ctrl.T.Helper()
...
// GetByID indicates an expected call of GetByID.
func (mr *MockCommentRepoMockRecorder) GetByID(ctx, commentID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCommentRepo) ListByPost(ctx context.Context, postID string, filter repo.CommentFilter) ([]entity.Comment, int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListByPost", ctx, postID, filter)
	ret0, _ := ret[0].([]entity.Comment)
	ret1, _ := ret[1].(int)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockCommentRepoMockRecorder) ListByPost(ctx, postID, filter any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByPost", reflect.TypeOf((*MockCommentRepo)(nil).ListByPost), ctx, postID, filter)
}

// Store mocks base method.
func (m *MockCommentRepo) Store(ctx context.Context, comment *entity.Comment) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Store", ctx, comment)
	ret0, _ := ret[0].(error)
	return ret0
}

// Store indicates an expected call of Store.
func (mr *MockCommentRepoMockRecorder) Store(ctx, comment any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockCommentRepo)(nil).Store), ctx, comment)
}

// Update mocks base method.
func (m *MockCommentRepo) Update(ctx context.Context, comment *entity.Comment) error {
	m.ctrl.T.Helper()
...
// Update indicates an expected call of Update.
func (mr *MockCommentRepoMockRecorder) Update(ctx, comment any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
