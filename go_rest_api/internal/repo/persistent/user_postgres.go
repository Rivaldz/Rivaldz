...
func (r *UserRepo) GetByID(ctx context.Context, id string) (entity.User, error) {
	return r.getUser(ctx, columnID, id)
}
...
func (r *UserRepo) getUser(ctx context.Context, column, value string) (entity.User, error) { //nolint:dupl // mirrors the standard repo lookup pattern
	sql, args, err := r.Builder.
