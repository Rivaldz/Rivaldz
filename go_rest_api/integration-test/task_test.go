...
import (
	...
	protov1 "github.com/Rivaldz/my-template-go/docs/proto/v1"
	natsClient "github.com/Rivaldz/my-template-go/pkg/nats/nats_rpc/client"
	rmqClient "github.com/Rivaldz/my-template-go/pkg/rabbitmq/rmq_rpc/client"
...
func TestHTTPTaskErrorsV1(t *testing.T) { //nolint:dupl // mirrors the blog test pattern
